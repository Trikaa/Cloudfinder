...
not_run: WebUI.getText(findTestObject('Object Repository/Page_Cloudfinder  Search/dl_Name            Sam Yosemit (1)'))

WebUI.verifyTextPresent(variable1, true)

WebUI.click(findTestObject('Object Repository/Page_Cloudfinder  Search/input_btn btn-info (1)'))

WebUI.click(findTestObject('Object Repository/Page_Cloudfinder  Search/div_HOME            500 E Main'))
